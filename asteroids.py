...
class Game:
    ...
    def init_objects(self):
        ...
        self.game_objects.appende(spaceShip)
    ...
    def key_press(self, symbol, modifikatory):
        ...
        if symbol == key.A:
            pressed_keyboards.add(('vlavo', 0))
        if symbol == key.D:
            pressed_keyboards.add(('vpravo', 0))
        pass
    ...
    def key_release(self, symbol, modifikatory):
        ...
        if symbol == key.A:
            pressed_keyboards.discard(('vlavo', 0))
        if symbol == key.D:
            pressed_keyboards.discard(('vpravo', 0))
        pass
    """
    Start game metóda 
    """
